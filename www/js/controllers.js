/*
    ...
    In order to use this sample app, you must install both ngCordova and ngStorage through bower.
    ngCordova is required for oAuth identification
    ngStorage is used for local storage
